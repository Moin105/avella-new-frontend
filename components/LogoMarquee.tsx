...
export default function LogoMarquee() {
  ...
  const loop = React.useMemo(() => [...ITEMS, ...ITEMS], []);
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mt-6 relative overflow-hidden">
        ...
        {/* Motion reduced: no animation */}
        <div className="flex w-max items-center gap-10 motion-reduce:animate-none animate-marquee will-change-transform">
          {loop.map((item, i) => (
